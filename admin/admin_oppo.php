...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="oppo"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Oppo</h2></center></div>
			<br />
		...
		<div class="alert alert-info">
			<table class="table table-hover">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `product` WHERE category='oppo' ORDER BY product_id DESC") or die(mysqli_error($db));
