...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="iphone"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Iphone</h2></center></div>
			<br />
			...
			<table class="table table-hover">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `product` WHERE category='iphone' ORDER BY product_id DESC") or die(mysqli_error($db));
